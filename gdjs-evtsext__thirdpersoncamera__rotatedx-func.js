...
gdjs.evtsExt__ThirdPersonCamera__RotatedX.idToCallbackMap = new Map();
...
{eventsFunctionContext.returnValue = eventsFunctionContext.localVariables[0].getFromIndex(0).getAsNumber() * eventsFunctionContext.getArgument("X") - eventsFunctionContext.localVariables[0].getFromIndex(1).getAsNumber() * eventsFunctionContext.getArgument("Y");}
}
